...
Tolong bantu tulis Results section:
...
KEY FINDINGS:
[paste key results dari analysis]

RESEARCH QUESTIONS:
[paste original research questions]

STUDY LIMITATIONS:
[paste limitations identified]

Tolong bantu tulis Discussion section:
...
3. IMPLICATIONS (2-3 paragraphs)
   - Clinical/practical implications
   - Policy implications
   - Implementation considerations

4. LIMITATIONS (2 paragraphs)
   - Study-level limitations
   - Review-level limitations
   - Impact on conclusions

5. FUTURE RESEARCH (1-2 paragraphs)
...
**Problem 1: Word count exceeded**
- Prioritize most important content
- Combine related paragraphs
- Move detailed data to supplementary materials
- Use more concise language

**Problem 2: Weak introduction**
- Strengthen rationale dengan current literature
- Clarify research gaps
- Emphasize novelty dan significance
- Improve logical flow

**Problem 3: Results section unclear**
- Reorganize by research questions
- Use clear headings dan subheadings
- Separate findings from interpretation
- Add transitional sentences

**Problem 4: Discussion lacks depth**
- Expand comparison dengan existing literature
- Strengthen implications discussion
- Address limitations more thoroughly
- Improve future research recommendations

**Problem 5: Poor manuscript flow**
